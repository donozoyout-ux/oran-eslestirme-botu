...
CREATE TABLE IF NOT EXISTS match_intelligence_snapshots (
  id text PRIMARY KEY,
  canonical_event_id text NOT NULL,
...
CREATE INDEX IF NOT EXISTS match_intelligence_event_generated_idx ON match_intelligence_snapshots(canonical_event_id, generated_at DESC);
`;
